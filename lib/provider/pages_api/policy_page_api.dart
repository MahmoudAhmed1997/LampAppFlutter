...
class PolicyPageApi {
  ...
  PolicyPageApi({this.page, this.success, this.status});

  PolicyPageApi.fromJson(Map<String, dynamic> json) {
  ...
  Future<PolicyPageApi> fetchPolicy() async {
    final url = '${cons.Constants.apiUrl}/pages/privacy-policy/details';
    ...
    if (response.statusCode == 200) {
      ...
      return PolicyPageApi.fromJson(jsonDecode(response.body));
    } else {
