...
class ProductDetailsApi {
  ...
  ProductDetailsApi({this.product});

  ProductDetailsApi.fromJson(Map<String, dynamic> json) {
    product =
...
class Product {
  ...
  Future<ProductDetailsApi> fetchAbout() async {
    ...
    if (response.statusCode == 200) {
      ...
      return ProductDetailsApi.fromJson(jsonDecode(response.body));
    } else {
      print("products ${response.body}");
