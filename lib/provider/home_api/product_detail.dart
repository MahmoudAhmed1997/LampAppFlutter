...
class ProductDetailApi {
  ...
  ProductDetailApi({this.products});

  ProductDetailApi.fromJson(Map<String, dynamic> json) {
  ...
  Future<ProductDetailApi> fetchAbout() async {
    ...
    if (response.statusCode == 200) {
      ...
      return ProductDetailApi.fromJson(jsonDecode(response.body));
    } else {
...
class Data {
  ...
  String name;
  String details;
  List<TranslationsProductDetail> translations;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['translations'] != null) {
      translations = new List<TranslationsProductDetail>();
      json['translations'].forEach((v) {
        translations.add(new TranslationsProductDetail.fromJson(v));
      });
    }
  }
...
class TranslationsProductDetail{
  int id;
  String name;
  String details;
  int productId;
  ...
  TranslationsProductDetail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    details = json['details'];
    productId = json['product_id'];
