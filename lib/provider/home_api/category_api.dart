...
class CategoryApi {
  ...
  CategoryApi({this.designers, this.products});

  CategoryApi.fromJson(Map<String, dynamic> json) {
    if (json['designers'] != null) {
      designers = new List<Designers>();
      json['designers'].forEach((v) {
        designers.add(new Designers.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.designers != null) {
      data['designers'] = this.designers.map((v) => v.toJson()).toList();
    }
  ...
  Future<CategoryApi> fetchProductFiltersApi() async {
    final url = '${cons.Constants.apiUrl}/categories/1';
...
class Designers {
  ...
  String name;
  String details;
  List<TranslationsDes> translations;
  ...
  Designers.fromJson(Map<String, dynamic> json) {
    ...
    if (json['translations'] != null) {
      translations = new List<TranslationsDes>();
      json['translations'].forEach((v) {
        translations.add(new TranslationsDes.fromJson(v));
      });
    }
  }
...
class TranslationsDes {
  ...
  TranslationsDes.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    storeId = json['store_id'];
    name = json['name'];
    details = json['details'];
